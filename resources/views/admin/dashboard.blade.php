    ...
    <div class="container mx-auto mt-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-red-500 text-white p-4 rounded-lg shadow-md">
                ...
                <a href="{{ route('alumni.index') }}" class="text-white underline">View Details <i class="fa fa-arrow-circle-right"></i></a>
            </div>
            ...
            <div class="bg-blue-500 text-white p-4 rounded-lg shadow-md">
                ...
                <a href="/admin/tracer-kerja" class="text-white underline">View Details <i class="fa fa-arrow-circle-right"></i></a>
            </div>
            ...
            <div class="bg-yellow-500 text-white p-4 rounded-lg shadow-md">
                ...
                <a href="/admin/tracer-kuliah" class="text-white underline">View Details <i class="fa fa-arrow-circle-right"></i></a>
            </div>
            ...
            <div class="bg-green-500 text-white p-4 rounded-lg shadow-md">
                ...
                <a href="/admin/testimoni" class="text-white underline">View Details <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
